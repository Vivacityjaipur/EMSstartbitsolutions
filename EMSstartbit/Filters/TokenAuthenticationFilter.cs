...
namespace EMSstartbit.Filters
{
    public class TokenAuthenticationFilter : Attribute, IAsyncAuthorizationFilter
    {
        ...
        //            var eid = tokenManager.VerifyToken(token);
        //            Console.WriteLine(eid);
        //            var logdata = _ldata.getByEid(Convert.ToInt32(eid)); 
        //            if(logdata.is_active == false){
        //                throw new Exception("User is Locked");
        //            }
        //            var pd22 = pd.GetByEid(Convert.ToInt32(eid));
        //            foreach(var p in pd22)
        //            {
        //                if (p.permission_id == perid)
        //                {
        //                    check = false;
        //                }
        //            }
